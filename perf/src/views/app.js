...
const jumbotron = (
  <div class="jumbotron">
    <div class="row">
      <div class="col-md-6">
        <h1>@transclusion/vdom v1.0.0</h1>
      </div>
      <div class="col-md-6">
        <div class="row">
...
const tableView = ({rows, selected}) => (
  <table class="table table-hover table-striped">
    <tbody>{rows.map(row => vdom.thunk(rowView, {row, selected}))}</tbody>
  </table>
)
